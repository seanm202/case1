	...
	if(isset($_POST['add']))
	{
		...
		else if( isset($_POST['name']) && isset($_POST['email']))
		{
				...
				else
				{
					...
					$sql = "INSERT INTO users (user_id,name,email,password,Authority) VALUES ('',:name, :em,:pass,:auth)";
					$stmt = $pdo->prepare($sql);

					$stmt->execute(array(':name' => $_POST['name'],':em' => $_POST['email'],':pass' => $_POST['pass'],':auth' => $_POST['auth']));
